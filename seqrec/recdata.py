...
class NormalRecData:
    ...
    def load_data(self):
        ...
        source_dict = {
            ...
            "Goodreads_Poetry": "Goodreads_Poetry/5-core/downstream",
            "Goodreads_Poetry_Global": "Goodreads_Poetry/5-core/global_temporal_80_10_10/downstream",
        ...
        def read_data_from_file(domain, mode=''):
            # Resolve data relative to the distributed project directory,
